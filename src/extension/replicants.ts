...
export function getTwitchEventsReplicant(nodecg: BundleAPI): ReplicantTwitchEvents {
    return nodecg.Replicant(TWITCH_EVENTS_REPLICANT, {defaultValue: []});
