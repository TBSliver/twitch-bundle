...
function App() {
    ...
    const [availableVideos] = useReplicant<{
        [id: string]: NodeCG.AssetFile
    ...
    useEffect(() => {
        ...
        setVideoArray(Object.values(availableVideos).filter(e => e !== undefined).map(v => v.url).sort(() => Math.random() - 0.5));
        setArrayIndex(0);
    }, [availableVideos]);
