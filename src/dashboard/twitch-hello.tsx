...
export function App() {
    const [twitchHello, setTwitchHello] = useReplicant<TwitchHello[]>(TWITCH_HELLO_REPLICANT, {defaultValue: []});
    const [lastClear, setLastClear] = useReplicant<number>(TWITCH_HELLO_CLEAR_REPLICANT, {defaultValue: 0});
    const [twitchHelloIgnore, setTwitchHelloIgnore] = useReplicant<string[]>(TWITCH_HELLO_IGNORE_REPLICANT, {defaultValue: []});
